...
<head>
    ...
    <style>
        ...
        .container{
            margin-top: 20px;
            padding: 20px;
            background-image: url('https://images.livemint.com/img/2021/09/20/1140x641/beer-kolkata-zero-alcohol-Mint-Lounge_1632133058191_1632133076554.jpg');            background-size: cover;
            background-repeat: no-repeat;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <a class="navbar-brand" href="#">
            <img src="https://tse4.mm.bing.net/th/id/OIP.hXbUbGSPfzBD_cAHbeFYoAHaF7?rs=1&pid=ImgDetMain" alt="Logo">
        </a>
                        ...
                        <div class="col-sm-9">
                             ...
                             <div class="card review-card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle mb-2 text-muted">Rating: ${review.rating} <i class="fa-solid fa-star" style="color: #ffc107;"></i></h6>
            ...
            var reviewBox = document.getElementById('post-review-box');
                    ...
                    function highlightStars(value) {
                        stars.forEach(function (star) {
                            ...
                            console.log(offStars[starValue-1], starValue);
                        });
                    ...
                    '<div class="col-lg-12 col-md-12 col-sm-12 mb-4">'+
                        '<div class="card" style="width: 100%;">'+
                          ...
                          '<ul class="list-group list-group-flush">'+
                            ...
                            + '</li>' +
                            '<li class="list-group-item">' +
                                '<p class="card-text">Rating: ' + "${avgRating}" +'<i class="fa-solid fa-star" style="color: #ffc107;"></i>'
                            + '</li>' +
                          '</ul>'+
                          '<div class="card-body">'+
